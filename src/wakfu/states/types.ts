...
export type EnumWakfuState = (typeof EnumWakfuState)[keyof typeof EnumWakfuState];

const WakfuStates = new Set<string>(Object.values(EnumWakfuState));

export const isWakfuState = (value: unknown): value is EnumWakfuState => {
  return typeof value === "string" && WakfuStates.has(value);
};
