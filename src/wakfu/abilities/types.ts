...
export type EnumAbilities = (typeof EnumAbilities)[keyof typeof EnumAbilities];

const AbilityValues = new Set<string>(Object.values(EnumAbilities));

export const isEnumAbilities = (value: string): value is EnumAbilities => {
  return AbilityValues.has(value);
};
